...
WORKDIR "/src"
COPY . .
RUN dotnet publish "NetworkPerspective.Sync.Cli/NetworkPerspective.Sync.Cli.csproj" -c Release --self-contained --os linux -o /app/publish -p:PublishSingleFile=true
