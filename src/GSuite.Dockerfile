...
WORKDIR "/src/NetworkPerspective.Sync.GSuite"
RUN dotnet build "NetworkPerspective.Sync.GSuite.csproj" -c Release -o /app/build
WORKDIR "/src"
...
WORKDIR "/src/NetworkPerspective.Sync.GSuite"
RUN dotnet publish "NetworkPerspective.Sync.GSuite.csproj" -c Release -o /app/publish
