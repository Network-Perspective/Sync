...
namespace NetworkPerspective.Sync.Infrastructure.DataSources.Slack.Services
{
    ...
    {
        Task<SyncResult> SyncInteractionsAsync(IInteractionsStream stream, ISlackClientBotScopeFacade slackClientFacade, Guid connectorId, InteractionFactory interactionFactory, TimeRange timeRange, CancellationToken stoppingToken = default);
    }
    ...
    internal class ChatClient : IChatClient
    {
        ...
        public async Task<SyncResult> SyncInteractionsAsync(IInteractionsStream stream, ISlackClientBotScopeFacade slackClientFacade, Guid connectorId, InteractionFactory interactionFactory, TimeRange timeRange, CancellationToken stoppingToken = default)
        {
