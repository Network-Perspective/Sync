...
public class ExternalAzureKeyVaultClient : ISecretRepository
{
    ...
    private readonly ISecretRepository _internalSecretRepository;
    ...
    public ExternalAzureKeyVaultClient(Uri baseUri, ISecretRepository internalSecretRepository, ILogger<ExternalAzureKeyVaultClient> logger)
    {
        _baseUri = baseUri;
