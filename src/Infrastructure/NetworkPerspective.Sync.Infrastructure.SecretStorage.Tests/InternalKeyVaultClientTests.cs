...
using NetworkPerspective.Sync.Infrastructure.SecretStorage.AzureKeyVault.Tests.Fixtures;
...
public class InternalKeyVaultClientTests : IAsyncLifetime
{
    private const string KeyNameTemplate = "test-key-{0}";

    private readonly string _keyName;
    private readonly InternalAzureKeyVaultClient _client;

    public InternalKeyVaultClientTests(AzureKeyVaultFixture fixture)
    {
        _keyName = string.Format(KeyNameTemplate, Guid.NewGuid().ToString());
        _client = fixture.InternalClient;
    }
    ...
    public class GetSecret : InternalKeyVaultClientTests
    {
    ...
    public class SetSecret : InternalKeyVaultClientTests
    {
    ...
    public class RemoveSecret : InternalKeyVaultClientTests
    {
