...
namespace NetworkPerspective.Sync.Application.Tests.Domain.Interactions
{
    public class NonBotInteractionCriteriaTests
    {
        ...
        public void ShouldFilterOutBotTargetInteraction()
        {
            ...
            {
                Interaction.CreateEmail(DateTime.UtcNow, Employee.CreateBot("bot1"), Employee.CreateInternal("internal1", "internal1_id", Array.Empty<Group>()), "id1"),
                Interaction.CreateEmail(DateTime.UtcNow, Employee.CreateInternal("internal2", "internal2_id", Array.Empty<Group>()), Employee.CreateBot("bot2"), "id2"),
