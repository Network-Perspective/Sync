...
namespace NetworkPerspective.Sync.Worker.Application.Tests.Domain.Employees
{
    public class EmployeeTests
    {
        ...
        public void ShouldHashSensitiveData()
        {
            ...
            var relation = new RelationsCollection([Relation.Create(Relation.SupervisorRelationName, managerEmail)]);
        ...
        public void ShouldAddUsernameMatchingWhitelist()
        {
            ...
            var emailFilter = new EmployeeFilter(whitelist, []);
        ...
        public void ShouldNotOutputTeamWhenNotAssigned()
        {
            ...
            // Act
            var employee = Employee.CreateInternal(EmployeeId.Create("bar", "baz"), [group]);
