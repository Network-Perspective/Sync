...
public class Employee
{
    ...
    public const string PropKeyTimezone = "Timezone";
    ...
    public static Employee CreateInternal(EmployeeId id, IEnumerable<Group> groups, IDictionary<string, object> props = null, RelationsCollection relations = null, IEnumerable<string> groupAccess = null)
        => new(id, groups, false, false, false, props ?? new Dictionary<string, object>(), relations ?? RelationsCollection.Empty, groupAccess);

    public static Employee CreateExternal(string email)
        => new(EmployeeId.Create(email, string.Empty), [], true, false, false, ImmutableDictionary<string, object>.Empty, RelationsCollection.Empty, null);

    public static Employee CreateBot(string email)
        => new(EmployeeId.Create(email, string.Empty), [], false, true, false, ImmutableDictionary<string, object>.Empty, RelationsCollection.Empty, null);
